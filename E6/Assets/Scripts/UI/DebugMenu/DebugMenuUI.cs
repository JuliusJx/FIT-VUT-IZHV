    ...
    private void MainWindowUI(int windowId)
    {
        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                var useMouse = GameManager.Instance.interactiveMode;
                useMouse = (bool)GUILayout.Toggle(useMouse, "UseMouse");
                if (GUI.changed)
                { GameManager.Instance.interactiveMode = useMouse; }
                ...
                mute = (bool)GUILayout.Toggle(mute, "Mute");
                if (GUI.changed)
